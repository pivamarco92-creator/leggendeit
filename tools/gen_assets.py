...
CREATURES = {
 ...
 'leon': dict(pal={'Y':(220,180,60,255),'y':(170,130,40,255),'B':(88,148,212,255),
   ...
   '................',
   '................']),
 # ---------- EMILIA-ROMAGNA — Fuoco Fatuo + Al Diâl ----------
 'foghin': dict(pal={'Y':(252,232,140,255),'F':(248,168,56,255),'f':(224,108,36,255),
   'K':(40,30,30,255),'W':(255,255,255,255)}, rows=[
   '................',
   '.......YY.......',
   '......YFFY......',
   '......FFFF......',
   ...
   '................',
   '................']),
 'fogaron': dict(pal={'Y':(252,232,140,255),'F':(246,150,46,255),'f':(214,96,32,255),
   'R':(236,80,40,255),'K':(40,30,30,255)}, rows=[
   '................',
   '......Y.Y.......',
   '.....YFYFY......',
   '.....FFFFF......',
   ...
   '................',
   '................']),
 'aldial': dict(pal={'R':(200,52,52,255),'r':(140,34,38,255),'K':(28,24,32,255),
   'Y':(248,216,80,255),'W':(240,240,240,255),'B':(40,30,40,255)}, rows=[
   '................',
   '..R..........R..',
   '..RR........RR..',
   '...RR......RR...',
   ...
   '...rr......rr...',
   '..B..........B..']),
 # ---------- TOSCANA — stregoneria + L'Arùspice (Psico) ----------
 'strio': dict(pal={'P':(150,110,190,255),'p':(110,76,150,255),'S':(232,190,148,255),
   'K':(30,26,40,255),'Y':(240,210,90,255),'W':(255,255,255,255)}, rows=[
   '................',
   '.......Y........',
   '......PPP.......',
   '.....PPPPP......',
   ...
   '................',
   '................']),
 'strione': dict(pal={'P':(140,100,182,255),'p':(100,68,140,255),'S':(232,190,148,255),
   'K':(30,26,40,255),'Y':(240,210,90,255),'B':(110,150,220,255)}, rows=[
   '................',
   '......Y.........',
   '.....YPY........',
   '....PPPPP.......',
   ...
   '...pp...pp......',
   '................']),
 'aruspice': dict(pal={'G':(224,196,90,255),'g':(170,140,50,255),'S':(232,190,148,255),
   'K':(30,26,40,255),'P':(150,110,190,255),'B':(110,150,220,255),'W':(245,245,250,255)}, rows=[
   '................',
   '....GGGGGG......',
   '...GGGGGGGG.....',
   '...GSSSSSSG.....',
   ...
   '................',
   '................']),
 # ---------- "I TRE SOCI" — Piva (Elettro) / Facci (Fuoco-Volante) / Licata (Acqua) ----------
 'pivot': dict(pal={'Y':(248,216,72,255),'y':(214,176,40,255),'K':(30,26,32,255),
   'R':(220,80,70,255),'W':(255,255,255,255)}, rows=[
   '................',
   '.....YYYY.......',
   '....YYYYYY......',
   '...YYYYYYYY.....',
   ...
   '................',
   '................']),
 'pivarol': dict(pal={'Y':(244,210,64,255),'y':(206,168,36,255),'K':(30,26,32,255),
   'R':(220,80,70,255),'W':(255,255,255,255)}, rows=[
   '................',
   '...Y......Y.....',
   '...YY....YY.....',
   ...
   '................',
   '................']),
 'pivon': dict(pal={'Y':(240,204,56,255),'y':(198,160,32,255),'K':(30,26,32,255),
   'R':(222,78,68,255),'W':(255,255,255,255)}, rows=[
   '................',
   '..Y..........Y..',
   '..YY........YY..',
   '..YYY......YYY..',
   ...
   '..y..........y..',
   '................']),
 'faccin': dict(pal={'O':(244,140,50,255),'o':(200,90,36,255),'K':(30,26,32,255),
   'R':(220,60,50,255),'W':(255,255,255,255),'Y':(248,210,90,255)}, rows=[
   '................',
   '.....OOOO.......',
   '....OOOOOO......',
   '...OOOOOOOO.....',
   ...
   '................',
   '................']),
 'facciotto': dict(pal={'O':(240,130,46,255),'o':(192,84,34,255),'K':(30,26,32,255),
   'R':(216,58,48,255),'W':(255,255,255,255),'Y':(248,210,90,255)}, rows=[
   '................',
   '..o........o....',
   '..oo......oo....',
   '...OOOOOOOO.....',
   ...
   '................',
   '................']),
 'faccion': dict(pal={'O':(236,120,42,255),'o':(186,78,32,255),'K':(30,26,32,255),
   'R':(214,54,46,255),'W':(255,255,255,255),'Y':(248,210,90,255)}, rows=[
   '................',
   '.o..........o...',
   '.oo........oo...',
   '.ooo......ooo...',
   ...
   '.o............o.',
   '................']),
 'licat': dict(pal={'B':(80,150,215,255),'b':(50,108,175,255),'C':(150,205,235,255),
   'K':(30,26,32,255),'W':(255,255,255,255)}, rows=[
   '................',
   '.....BBBB.......',
   '....BBBBBB......',
   '...BCBBBBCB.....',
   ...
   '................',
   '................']),
 'licatone': dict(pal={'B':(70,140,208,255),'b':(44,100,166,255),'C':(140,198,230,255),
   'K':(30,26,32,255),'W':(255,255,255,255)}, rows=[
   '................',
   '...B......B.....',
   '...BB....BB.....',
   ...
   '................',
   '................']),
 'licatass': dict(pal={'B':(60,130,200,255),'b':(38,92,158,255),'C':(135,194,228,255),
   'K':(30,26,32,255),'W':(255,255,255,255)}, rows=[
   '................',
   '..B..........B..',
   '..BB........BB..',
   ...
   '................',
   '................']),
 # ---------- UMBRIA — Terra + Lupo di Gubbio ----------
 'zollin': dict(pal={'B':(150,110,64,255),'b':(110,80,46,255),'G':(96,160,72,255),
   'g':(64,120,52,255),'K':(30,26,28,255),'W':(255,255,255,255)}, rows=[
   '................',
   '.......G........',
   '......GgG.......',
   '.....BBBBB......',
   ...
   '................',
   '................']),
 'zollone': dict(pal={'B':(140,102,58,255),'b':(102,74,42,255),'G':(90,152,66,255),
   'g':(58,112,48,255),'K':(30,26,28,255),'W':(255,255,255,255)}, rows=[
   '................',
   '....G.....G.....',
   '...GgG...GgG....',
   '...BBBBBBBBB....',
   ...
   '................',
   '................']),
 'lupogubbio': dict(pal={'G':(130,118,100,255),'g':(92,82,68,255),'W':(228,224,212,255),
   'K':(30,26,28,255),'R':(180,70,60,255)}, rows=[
   '................',
   '..G.......G.....',
   '..GG.....GG.....',
   '..GGGGGGGGG.....',
   ...
   '................',
   '................']),
 # ---------- MARCHE — Volante + Sibilla Appenninica ----------
 'falchin': dict(pal={'B':(150,110,64,255),'b':(104,76,44,255),'T':(210,180,120,255),
   'K':(30,26,28,255),'Y':(240,200,80,255),'W':(255,255,255,255)}, rows=[
   '................',
   '......BB........',
   '.....BBBB.......',
   '....BBKBBB......',
   ...
   '................',
   '................']),
 'falchione': dict(pal={'B':(140,102,58,255),'b':(98,72,42,255),'T':(204,174,114,255),
   'K':(30,26,28,255),'Y':(240,200,80,255),'W':(255,255,255,255)}, rows=[
   '................',
   '..B........B....',
   '..BB......BB....',
   ...
   '................',
   '................']),
 'sibilla': dict(pal={'P':(150,110,190,255),'p':(108,76,150,255),'G':(228,196,90,255),
   'S':(232,190,148,255),'K':(30,26,40,255),'W':(245,245,250,255)}, rows=[
   '................',
   '.....GGGG.......',
   '....G.GG.G......',
   '....WSSSSW......',
   ...
   '................',
   '................']),
 # ---------- LAZIO — Drago + Dracòne delle catacombe ----------
 'ruderin': dict(pal={'V':(96,160,90,255),'v':(62,116,60,255),'R':(210,80,70,255),
   'K':(30,26,28,255),'W':(255,255,255,255)}, rows=[
   '................',
   '......VVVV......',
   '.....VVVVVV.....',
   '.....VKVVKV.....',
   ...
   '................',
   '................']),
 'ruderone': dict(pal={'V':(82,146,80,255),'v':(52,104,52,255),'R':(206,76,66,255),
   'K':(30,26,28,255),'W':(255,255,255,255)}, rows=[
   '................',
   '..V.......V.....',
   '..VV.....VV.....',
   ...
   '................',
   '................']),
 'dracone': dict(pal={'V':(70,130,80,255),'v':(44,92,54,255),'P':(120,90,160,255),
   'R':(210,74,66,255),'Y':(240,210,90,255),'K':(30,26,28,255),'W':(245,245,250,255)}, rows=[
   '................',
   '.V..........V...',
   '.VV........VV...',
   '.VVV......VVV...',
   ...
   '................',
   '................']),
 # ---------- COMUNI del centro-sud (varietà incontri) ----------
 'cinghial': dict(pal={'B':(130,96,60,255),'b':(92,68,42,255),'D':(70,52,34,255),
   'W':(235,228,205,255),'K':(28,24,22,255)}, rows=[
   '................',
   '................',
   '...B........B...',
   '...BB......BB...',
   ...
   '................',
   '................']),
 'pantafica': dict(pal={'P':(130,120,150,255),'p':(90,82,110,255),'W':(215,210,225,255),
   'R':(180,70,90,255),'K':(28,24,32,255)}, rows=[
   '................',
   '.....PPPP.......',
   '....PPPPPP......',
   '...PPWPPWPP.....',
   ...
   '................',
   '................']),
 'luccicola': dict(pal={'K':(50,46,40,255),'G':(96,150,70,255),'Y':(250,238,120,255),
   'y':(220,200,70,255),'W':(255,255,255,255)}, rows=[
   '................',
   '.......KK.......',
   '......KKKK......',
   '.....KKKKKK.....',
   ...
   '................',
   '................']),
 # ---------- COMUNI del nord (varietà incontri) ----------
 'pantegana': dict(pal={'G':(120,118,124,255),'g':(84,82,90,255),'P':(210,150,150,255),
   'K':(28,24,22,255),'W':(255,255,255,255)}, rows=[
   '................',
   '..G........G....',
   '..GGP....PGG....',
   '...GGGGGGGG.....',
   ...
   '................',
   '................']),
 'ranot': dict(pal={'G':(96,170,90,255),'g':(60,128,62,255),'Y':(200,215,150,255),
   'W':(245,245,250,255),'K':(28,24,28,255)}, rows=[
   '................',
   '...GG....GG.....',
   '..GWWG..GWWG....',
   '..GWKG..GWKG....',
   ...
   '................',
   '................']),
 'gazzot': dict(pal={'K':(40,38,46,255),'W':(240,240,245,255),'B':(90,120,200,255),
   'Y':(230,200,80,255)}, rows=[
   '................',
   '......KK........',
   '.....KKKK.......',
   '.....KKKW.......',
   ...
   '................',
   '................']),
 # ---------- ABRUZZO — Roccia + Il Dormiente del Gran Sasso ----------
 'petrin': dict(pal={'G':(140,130,118,255),'g':(96,88,78,255),'W':(190,182,168,255),
   'K':(28,24,24,255)}, rows=[
   '................',
   '................',
   '.....GGGG.......',
   ...
   '................',
   '................']),
 'petrone': dict(pal={'G':(132,122,110,255),'g':(88,80,70,255),'W':(184,176,162,255),
   'K':(28,24,24,255)}, rows=[
   '................',
   '...GGG....GGG...',
   '..GGGGGGGGGGGG..',
   ...
   '................',
   '................']),
 'dormiente': dict(pal={'G':(130,120,108,255),'g':(88,80,70,255),'W':(228,226,218,255),
   'Y':(240,210,90,255),'M':(110,150,80,255),'K':(28,24,24,255)}, rows=[
   '................',
   '..WWW....WWW....',
   '.WGGGGGGGGGGGW..',
   '.GGGGGGGGGGGGG..',
   ...
   '................',
   '................']),
 # ---------- MOLISE (segreta) — Spettro + Il Dimenticato ----------
 'svanin': dict(pal={'C':(200,210,230,255),'c':(150,165,195,255),'W':(240,245,255,255),
   'K':(40,40,60,255)}, rows=[
   '................',
   '.....CCCC.......',
   '....CWWWWC......',
   ...
   '................',
   '................']),
 'svanone': dict(pal={'C':(190,202,225,255),'c':(140,156,190,255),'W':(236,242,252,255),
   'K':(40,40,60,255)}, rows=[
   '................',
   '....CCCCCC......',
   '...CWWWWWWC.....',
   ...
   '................',
   '................']),
 'dimenticato': dict(pal={'C':(200,210,230,255),'c':(140,155,190,255),'W':(240,245,255,255),
   'P':(150,130,180,255),'Y':(220,210,140,255),'K':(40,40,60,255)}, rows=[
   '................',
   '....C.CC.C......',
   '....CCCCCC......',
   '...CWWWWWWC.....',
   ...
   '................',
   '................']),
 # ---------- CAMPANIA — Fuoco + Partenope ----------
 'vesuvin': dict(pal={'R':(216,70,50,255),'r':(150,40,38,255),'O':(244,150,60,255),
   'Y':(250,220,110,255),'K':(28,24,24,255)}, rows=[
   '................',
   '......RR........',
   '.....RYYR.......',
   '.....YRRY.......',
   ...
   '................',
   '................']),
 'vesuvione': dict(pal={'R':(210,64,46,255),'r':(146,38,36,255),'O':(244,150,60,255),
   'Y':(250,220,110,255),'W':(220,220,225,255),'K':(28,24,24,255)}, rows=[
   '................',
   '..W....W....W...',
   '...RR..R..RR....',
   '....RYYRYYR.....',
   ...
   '................',
   '................']),
 'partenope': dict(pal={'B':(88,148,212,255),'b':(56,108,178,255),'C':(120,200,200,255),
   'Y':(240,210,90,255),'S':(232,190,148,255),'K':(30,26,40,255)}, rows=[
   '................',
   '.....YYYY.......',
   '....YSSSSY......',
   '....SKSSKS......',
   ...
   '................',
   '................']),
 # ---------- Asso di Johnny Lametta — TUTTOBÈNE (gangster in gessato) ----------
 'tuttobene': dict(pal={'K':(40,38,52,255),'k':(26,24,34,255),'S':(232,190,148,255),
   'W':(240,240,245,255),'G':(240,210,90,255),'R':(180,50,60,255)}, rows=[
   '................',
   '...KKKKKKKK.....',
   '..KKKKKKKKKK....',
   '...SSSSSSSS.....',
   ...
   '................',
   '................']),
 # ---------- PUGLIA — Luce + Solleone ----------
 'lumin': dict(pal={'Y':(250,230,120,255),'y':(228,200,70,255),'W':(255,255,255,255),
   'K':(60,50,30,255)}, rows=[
   '................',
   '.......Y........',
   '...Y...Y...Y....',
   ...
   '................',
   '................']),
 'luminone': dict(pal={'Y':(250,224,100,255),'y':(224,194,64,255),'W':(255,255,255,255),
   'K':(60,50,30,255)}, rows=[
   '................',
   '...Y...Y...Y....',
   '....Y..Y..Y.....',
   ...
   '................',
   '................']),
 'solleone': dict(pal={'G':(245,205,70,255),'g':(210,165,40,255),'W':(255,250,220,255),
   'O':(250,180,70,255),'R':(220,120,50,255),'K':(60,44,24,255)}, rows=[
   '................',
   '..G.G.G.G.G.G...',
   '...GGGGGGGGGG...',
   '..GGOOOOOOOOGG..',
   ...
   '................',
   '................']),
 # ---------- BASILICATA — Terra + Calanco ----------
 'monachin': dict(pal={'B':(150,110,64,255),'b':(104,76,44,255),'R':(200,70,60,255),
   'S':(232,190,148,255),'K':(30,26,28,255)}, rows=[
   '................',
   '......RRRR......',
   '.....RRRRRR.....',
   '.....RSSSSR.....',
   ...
   '................',
   '................']),
 'monachione': dict(pal={'B':(142,104,58,255),'b':(98,72,42,255),'R':(196,66,56,255),
   'S':(232,190,148,255),'K':(30,26,28,255)}, rows=[
   '................',
   '.....RRRRRR.....',
   '....RRRRRRRR....',
   ...
   '................',
   '................']),
 'calanco': dict(pal={'B':(170,120,70,255),'b':(120,82,48,255),'C':(90,60,34,255),
   'W':(210,180,140,255),'Y':(240,200,90,255),'K':(30,26,24,255)}, rows=[
   '................',
   '...BBB....BBB...',
   '..BBBBBBBBBBBB..',
   '..BBWBBBBBBWBB..',
   ...
   '................',
   '................']),
 'scursune': dict(pal={'G':(96,164,84,255),'g':(64,118,56,255),'V':(150,104,178,255),
   'K':(20,18,24,255)}, rows=[
   '................',
   '......GGGG......',
   '.....GGGGGG.....',
   ...
   '.........gg.....',
   '................']),
 'scursone': dict(pal={'G':(80,150,72,255),'g':(52,104,48,255),'V':(150,104,178,255),
   'W':(232,232,160,255),'K':(20,18,24,255)}, rows=[
   '................',
   '.....GGGGGG.....',
   '....GGGGGGGG....',
   '....GKGGGGKG....',
   ...
   '.......gg.......',
   '................']),
 'fatamorgana': dict(pal={'W':(214,230,246,255),'V':(150,160,214,255),'B':(96,148,212,255),
   'Y':(240,224,150,255),'K':(40,40,80,255)}, rows=[
   '......YYYY......',
   '.....WVVVVW.....',
   '.....WKWWKW.....',
   '.....WWVVWW.....',
   ...
   '.BB.BB.BB.BB.BB.',
   '................']),
 'mammucca': dict(pal={'D':(74,62,96,255),'d':(48,40,66,255),'R':(214,72,72,255),
   'W':(232,232,240,255),'K':(16,14,22,255)}, rows=[
   '................',
   '......dddd......',
   '.....dDDDDd.....',
   '....dDDDDDDd....',
   ...
   '................',
   '................']),
 'mammadraga': dict(pal={'D':(64,52,88,255),'d':(40,32,58,255),'R':(206,64,64,255),
   'W':(236,236,244,255),'Y':(238,206,96,255),'K':(14,12,20,255)}, rows=[
   '................',
   '.....dddddd.....',
   '....dDDDDDDd....',
   '...dDDDDDDDDd...',
   ...
   '..dd........dd..',
   '................']),
 'colapesce': dict(pal={'B':(64,118,176,255),'b':(40,80,128,255),'D':(54,52,86,255),
   'W':(226,236,246,255),'C':(120,196,210,255),'K':(14,16,30,255)}, rows=[
   '................',
   '......BBBB......',
   '.....BBBBBB.....',
   '.....BWKKWB.....',
   ...
   '...CC......CC...',
   '................']),
 'janedda': dict(pal={'P':(196,150,214,255),'p':(150,110,176,255),'Y':(242,214,120,255),
   'W':(238,232,246,255),'K':(40,28,56,255)}, rows=[
   '................',
   '.......YY.......',
   '......pPPp......',
   '.....pPPPPp.....',
   ...
   '................',
   '................']),
 'jana': dict(pal={'P':(186,134,210,255),'p':(140,98,168,255),'Y':(244,216,124,255),
   'W':(240,234,248,255),'K':(36,24,52,255)}, rows=[
   '......YYYY......',
   '.....pPPPPp.....',
   '....pPPPPPPp....',
   '....PWKPPKWP....',
   ...
   '...pp......pp...',
   '................']),
 'prama': dict(pal={'S':(176,166,150,255),'s':(126,118,104,255),'D':(86,80,70,255),
   'O':(60,120,170,255),'K':(28,26,22,255)}, rows=[
   '................',
   '.....SSSSSS.....',
   '....SSSSSSSS....',
   '....SOSSSSOS....',
   ...
   '..ss........ss..',
   '................']),
 'gattorco': dict(pal={'G':(150,150,160,255),'g':(96,96,110,255),'Y':(240,210,90,255),'K':(20,18,26,255)}, rows=[
   '................',
   '..G..........G..',
   '..GG........GG..',
   '..GGGG....GGGG..',
   ...
   '................',
   '................']),
 'lupercone': dict(pal={'B':(120,86,56,255),'b':(80,56,36,255),'W':(238,238,230,255),'R':(200,70,60,255),'K':(18,14,12,255)}, rows=[
   '................',
   '..B..........B..',
   '..BB........BB..',
   '..BBB......BBB..',
   ...
   '................',
   '................']),
 'mascaria': dict(pal={'P':(150,104,178,255),'p':(96,64,120,255),'K':(18,14,24,255),'Y':(238,210,90,255),'W':(232,226,240,255)}, rows=[
   '.......KK.......',
   '......KKKK......',
   '.....KKKKKK.....',
   '....KKKKKKKK....',
   ...
   '................',
   '................']),
 'basilisso': dict(pal={'G':(96,164,84,255),'g':(60,112,56,255),'V':(150,104,178,255),'Y':(240,210,90,255),'K':(16,14,20,255)}, rows=[
   '....YY....YY....',
   '....GG....GG....',
   '.....GGGGGG.....',
   '....GGGGGGGG....',
   ...
   '......gg........',
   '................']),
 'fogherone': dict(pal={'R':(220,70,40,255),'O':(244,150,40,255),'Y':(246,222,110,255),'K':(40,16,10,255)}, rows=[
   '.......Y........',
   '......YOY.......',
   '......OOO.......',
   '.....OOROO......',
   ...
   '.....RRRRRR.....',
   '................']),
 'brinalpino': dict(pal={'C':(150,210,235,255),'c':(96,160,200,255),'W':(236,246,250,255),'K':(30,50,70,255)}, rows=[
   '.......W........',
   '......WCW.......',
   '.....WCCCW......',
   '....WCCKCCW.....',
   ...
   '................',
   '................']),
 'mazarselva': dict(pal={'G':(96,168,80,255),'g':(60,112,56,255),'B':(88,148,212,255),'Y':(240,210,90,255),'K':(20,30,18,255)}, rows=[
   '....G..GG..G....',
   '...GG.GGGG.GG...',
   '....GGGGGGGG....',
   '...GGGGGGGGGG...',
   ...
   '................',
   '................']),
 'striastrale': dict(pal={'P':(150,110,200,255),'p':(98,70,150,255),'Y':(244,224,130,255),'W':(236,232,248,255),'K':(24,18,40,255)}, rows=[
   '.....Y...Y......',
   '......PPPP....Y.',
   '.....PPPPPP.....',
   '.....PWKKWP.....',
   ...
   '......Y..Y......',
   '................']),
 'cjargane': dict(pal={'W':(232,238,244,255),'C':(160,196,212,255),'c':(110,150,176,255),'K':(40,56,72,255)}, rows=[
   '................',
   '...CC......CC...',
   '..CCCCC..CCCCC..',
   '...CCCWWWWCCC...',
   ...
   '................',
   '................']),
 'rudimpero': dict(pal={'P':(120,90,160,255),'p':(80,58,112,255),'Y':(240,210,90,255),'R':(206,64,64,255),'K':(18,14,24,255)}, rows=[
   '..Y..........Y..',
   '..PP........PP..',
   '..PPP......PPP..',
   '..PPPP....PPPP..',
