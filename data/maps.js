...
const PORTALS = {
  ...
  milano: { D: { map:'lab',    x:4,  y:6,  dir:'up' },
            ...
            S: { map:'torino', x:25, y:19, dir:'left', heal: true,
                 lock: () => !G.flags.badge,
                 msg: ["STAZIONE CENTRALE.\nIl Frecciarossa per Torino sbuffa\nsul binario 7.",
                       "Il controllore ti squadra:\n«Prima la Medaglia Madonnina,\npoi i viaggi, bagai.»"],
                 arriveMsg: ["TORINO. Porta Nuova.\nAria fina, caffè più seri,\nportici a perdita d'occhio.",
                             "Il viaggio in treno ha rimesso\nin sesto la squadra!"] } },
  parco:  { E: { map:'milano', x:13, y:1,  dir:'down' } },
  gym:    { E: { map:'milano', x:24, y:5,  dir:'down' } },
  torino: { S: { map:'milano', x:27, y:2,  dir:'down', heal: true,
                 arriveMsg: ["MILANO. Casa.\nIl viaggio in treno ha rimesso\nin sesto la squadra!"] },
            ...
            V: { map:'aosta',  x:13, y:15, dir:'up', heal: true,
                 lock: () => !G.flags.badge2,
                 msg: ["Stazione bus per la VALLE D'AOSTA.\nDue ore di tornanti.",
                       "L'autista scuote la testa:\n«Senza la Medaglia della Mole,\nlassù, non ti aprono niente.»"],
                 arriveMsg: ["VALLE D'AOSTA. Aosta.\nAria sottile, neve sulle vette,\nil Monte Bianco che guarda tutto.",
  ...
  aosta:  { V: { map:'torino', x:14, y:3,  dir:'down', heal: true,
                 arriveMsg: ["TORINO. Di nuovo sotto i portici.\nIl viaggio ha rimesso in sesto\nla squadra!"] },
