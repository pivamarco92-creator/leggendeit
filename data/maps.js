/* Mappe in ASCII — ogni carattere è un tile.
   ...
   21 laptop(deposito) · 22 fiori · 23 cespuglio · 24 girasole  (tile da Sprout Lands)
...
const MAPS = {
  milano: {
    t2i: { '.':0, ',':1, 'G':3, 'T':4, 'W':5, '#':7, 'M':8, 'D':9, 'Y':10, 'K':11, 'P':15, 'E':12, 'S':12, 'H':18, 'N':12, 'C':9 , 'f':22, 'b':23, 'o':24 },
    tiles: [
  ...
  torino: {
    t2i: { '.':0, 'G':3, 'T':4, 'W':5, '#':7, 'O':17, 'L':16, 'Y':10, 'S':12, 'H':18, 'V':12, 'P':12 , 'f':22, 'b':23, 'o':24 },
    tiles: [
      'TTTTTTTTTTTTTTTTTTTTTTTTTTTTTT',
      'T.............V..............T',
      'T..####..####....OOOO...LL...T',
  ...
  napoli: {
    t2i: { '.':0, 'W':5, 'G':3, 'T':4, '#':7, 'Y':10, 'H':18, 'R':12, 'V':12, 'B':12 , 'f':22, 'b':23, 'o':24 },
    tiles: [
      'TTTTTTTTTTTTTTTTTTTTTTTTTTTT',
      'T..........................T',
      'T.##..####..####..####..##.T',
