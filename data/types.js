...
const TYPE_EFF = {
  ...
  Erba:       { Acqua:2, Roccia:2, Fuoco:.5, Erba:.5, Volante:.5, Veleno:.5, Coleottero:.5, Acciaio:.5 },
  Elettro:    { Acqua:2, Volante:2, Erba:.5 },
  Volante:    { Erba:2, Coleottero:2, Elettro:.5, Acciaio:.5, Roccia:.5 },
  Coleottero: { Erba:2, Fuoco:.5, Volante:.5, Veleno:.5, Acciaio:.5, Roccia:.5 },
  ...
  Roccia:     { Fuoco:2, Volante:2, Ghiaccio:2, Coleottero:2, Acciaio:.5 },
